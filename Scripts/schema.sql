...
(
  ...
  status varchar(16) NOT NULL DEFAULT 'Active' CHECK (status IN ('Active', 'Closed', 'Suspended', 'Aborted', 'Deleted')),
...
(
  ...
  status varchar(16) NOT NULL DEFAULT 'Paid' CHECK (status IN ('Paid', 'Deleted')),
  patient_id int NOT NULL,
  discount_id int NOT NULL,
