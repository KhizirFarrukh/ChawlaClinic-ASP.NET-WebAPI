namespace ChawlaClinic.Common.Commons
{
    public class CustomMessage
    {
        ...
        public const string PHONENUMBER_ALREADY_EXIST = "Phone Number already exists.";
    ...
    {
        public const string ENDPOINT_PREFIX = "api/[controller]";
    }
